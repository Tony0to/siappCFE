...
class _Tema1State extends State<Tema1> with TickerProviderStateMixin {
      ...
      setState(() {
        _contentData = {
          ...
          'video': {
            ...
            'videoId': 'f10jKIslSUY', // Placeholder; replace with Module 3-specific video ID
          },
        };
  ...
  void _initializeVideo() {
    setState(() {
      _showVideo = true;
      try {
        final videoId = _contentData?['video']?['videoId']?.toString() ?? 'f10jKIslSUY';
  ...
  Widget buildSubsectionPage(Map<String, dynamic>? sectionData, int index, int totalPages) {
    ...
    final activity = _activities.firstWhere(
      (act) => act['subtopic'] == 'Introducción a los algoritmos',
      orElse: () => {},
    );
