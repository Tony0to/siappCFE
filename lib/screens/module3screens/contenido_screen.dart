...
class Module3ContenidoScreen extends StatefulWidget {
  final Map<String, dynamic> moduleData;

  const Module3ContenidoScreen({Key? key, required this.moduleData}) : super(key: key);

  @override
  _Module3ContenidoScreenState createState() => _Module3ContenidoScreenState();
}

class _Module3ContenidoScreenState extends State<Module3ContenidoScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final moduleImage = widget.moduleData['image'] as String? ??
        'https://img.freepik.com/free-vector/algorithm-concept-illustration_114360-1438.jpg';
                                      ...
                                      return Padding(
                                        ...
                                        child: SectionCard(
                                          ...
                                          onTap: () async {
                                            ...
                                            switch (index) {
                                              case 0:
                                                targetScreen = Module3Tema1Screen(
                                                  section: section,
                                                ...
                                                break;
                                              case 1:
                                                targetScreen = Module3Tema2Screen(
                                                  section: section,
                                                  moduleData: widget.moduleData,
                                                  sectionIndex: index,
                                                  totalSections: content.length,
                                                ...
                                                break;
                                              case 2:
                                                targetScreen = Module3Tema3Screen(
                                                  section: section,
                                                  moduleData: widget.moduleData,
                                                  sectionIndex: index,
                                                  totalSections: content.length,
                                                ...
                                                break;
                                              case 3:
                                                targetScreen = Module3Tema4Screen(
                                                  section: section,
                                                  moduleData: widget.moduleData,
                                                  sectionIndex: index,
                                                  totalSections: content.length,
