...
class Module3Tema4Screen extends StatefulWidget {
  ...
  @override
  State<Module3Tema4Screen> createState() => _Module3Tema4ScreenState();
}

class _Module3Tema4ScreenState extends State<Module3Tema4Screen> with TickerProviderStateMixin {
  ...
  Set<String> _shownImages = {};

  static final Map<String, String> _sectionImages = {
    // Tema 4: Aplicación de algoritmos en problemas reales
    'aplicacion_general': 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80',
    'aplicacion_problemas_reales': 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80',
    'algoritmos_estructuras_datos': 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80',
    'resolucion_problemas_cotidianos': 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80',
    'desarrollo_proyectos_practicos': 'https://images.unsplash.com/photo-1517430816045-df4b7de11d1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80',
  };
  ...
  Future<void> _loadJsonContent() async {
    ...
    try {
      ...
      final sectionContent = data['content']['section_4'];

      final activities = data['activities'] as List<dynamic>;
      final tema4Activity = activities.firstWhere(
        (activity) => activity['subtopic'] == 'Aplicación de algoritmos en problemas reales',
        orElse: () => null,
      );

      if (tema4Activity == null) {
        throw Exception('No se encontró la actividad para el tema 4');
      }

      setState(() {
        _contentData = {
          ...sectionContent,
          'objective': tema4Activity['objective'],
          'theory': tema4Activity['theory'],
          'reflection': tema4Activity['reflection'],
          'practice': tema4Activity['practice'],
        };
        _quizQuestions = tema4Activity['theory']['questions'];
  ...
  Widget _buildSectionImage() {
    final imageUrl = _sectionImages['aplicacion_general']!;
    return Container(
      height: 220,
            ...
            child: Column(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: Text(
                    _contentData?['title']?.toString() ?? widget.section['title'] ?? 'Aplicación de algoritmos',
  ...
  Map<String, String>? _getImageForSubsection(String title) {
    ...
    if (lowerTitle.contains('aplicación') || lowerTitle.contains('aplicacion') || 
        lowerTitle.contains('problemas reales') || lowerTitle.contains('introducción') || 
        lowerTitle.contains('introduccion')) {
      debugPrint('Asignando imagen: aplicacion_problemas_reales');
      return {'key': 'aplicacion_problemas_reales', 'caption': 'Aplicación en problemas reales'};
    }
    if (lowerTitle.contains('estructuras de datos') || lowerTitle.contains('árboles') || 
        lowerTitle.contains('arboles') || lowerTitle.contains('listas')) {
      debugPrint('Asignando imagen: algoritmos_estructuras_datos');
      return {'key': 'algoritmos_estructuras_datos', 'caption': 'Algoritmos en estructuras de datos'};
    }
    if (lowerTitle.contains('resolución') || lowerTitle.contains('resolucion') || 
        lowerTitle.contains('cotidianos') || lowerTitle.contains('optimización') || 
        lowerTitle.contains('optimizacion')) {
      debugPrint('Asignando imagen: resolucion_problemas_cotidianos');
      return {'key': 'resolucion_problemas_cotidianos', 'caption': 'Resolución de problemas cotidianos'};
    }
    if (lowerTitle.contains('proyectos') || lowerTitle.contains('prácticos') || 
        lowerTitle.contains('practicos') || lowerTitle.contains('desarrollo')) {
      debugPrint('Asignando imagen: desarrollo_proyectos_practicos');
      return {'key': 'desarrollo_proyectos_practicos', 'caption': 'Desarrollo de proyectos prácticos'};
    }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            widget.section['title'] ?? 'Aplicación de algoritmos',
              ...
              children: [
                ...
                ...subsections.expand((subsection) {
                  ...
                  if (imageInfo != null && !_shownImages.contains(imageInfo['key'])) {
                    ...
                    _shownImages.add(imageInfo['key']!);
