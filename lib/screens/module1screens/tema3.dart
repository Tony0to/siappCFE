...
class Tema3Screen extends StatefulWidget {
  ...
  @override
  State<Tema3Screen> createState() => _Tema3ScreenState();
}

class _Tema3ScreenState extends State<Tema3Screen> with TickerProviderStateMixin {
  ...
  Future<void> _loadJsonContent() async {
    ...
    try {
      ...
      final tema3Activity = activities.firstWhere(
        (activity) => activity['subtopic'] == 'Introducción a los diagramas de flujo',
        orElse: () => null,
      );
  ...
  Widget _buildSectionImage() {
    final imageUrl = _sectionImages['diagramas_flujo']!;
    return Container(
      height: 220,
            ...
            child: Column(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: Text(
                    _contentData?['title']?.toString() ?? widget.section['title'] ?? 'Diagramas de flujo y pseudocódigo',
  ...
  void _navigateNext() {
    ...
    if (widget.sectionIndex + 1 < widget.totalSections) {
      ...
      Navigator.pushReplacement(
        context,
        PageRouteBuilder(
          pageBuilder: (context, animation, secondaryAnimation) => Tema4Screen(
            section: nextSection,
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            widget.section['title'] ?? 'Diagramas de flujo y pseudocódigo',
