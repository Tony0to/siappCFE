...
class Tema2Screen extends StatefulWidget {
  ...
  @override
  State<Tema2Screen> createState() => _Tema2ScreenState();
}

class _Tema2ScreenState extends State<Tema2Screen> with TickerProviderStateMixin {
  ...
  Future<void> _loadJsonContent() async {
    ...
    try {
      ...
      final tema2Activity = activities.firstWhere(
        (activity) => activity['subtopic'] == 'Pensamiento lógico y resolución de problemas',
        orElse: () => null,
      );
  ...
  Widget _buildSectionImage() {
    final imageUrl = _sectionImages['bajo_alto_nivel']!;
    return Container(
      height: 220,
            ...
            child: Column(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: Text(
                    _contentData?['title']?.toString() ?? widget.section['title'] ?? 'Lenguajes de programación',
  ...
  void _navigateNext() {
    ...
    if (widget.sectionIndex + 1 < widget.totalSections) {
      ...
      Navigator.pushReplacement(
        context,
        PageRouteBuilder(
          pageBuilder: (context, animation, secondaryAnimation) => Tema3Screen(
            section: nextSection,
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            widget.section['title'] ?? 'Lenguajes de programación',
