...
class Tema4Screen extends StatefulWidget {
  ...
  @override
  State<Tema4Screen> createState() => _Tema4ScreenState();
}

class _Tema4ScreenState extends State<Tema4Screen> with TickerProviderStateMixin {
  ...
  // Almacenar las respuestas seleccionadas para cada pregunta
  Map<int, String?> _selectedAnswers = {};
  // Mapa para almacenar si las respuestas son correctas
  ...
  Future<void> _loadJsonContent() async {
    ...
    try {
      ...
      // Obtener el contenido de la sección 4
      final sectionContent = data['content']['section_4'];

      // Buscar la actividad correspondiente al tema 4 (Pensamiento lógico y resolución de problemas)
      final activities = data['activities'] as List<dynamic>;
      final tema4Activity = activities.firstWhere(
        (activity) => activity['subtopic'] == 'Conceptos clave en diagramas de flujo',
        orElse: () => null,
      );
      ...
      setState(() {
        ...
        // Inicializar _selectedAnswers y _isCorrect dinámicamente según el número de preguntas
  ...
  Widget _buildSectionImage() {
    final imageUrl = _getImageForSection(widget.section['title']);
    return Container(
      height: 220,
            ...
            child: Column(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: Text(
                    _contentData?['title']?.toString() ?? widget.section['title'] ?? 'Pensamiento lógico y resolución de problemas',
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            widget.section['title'] ?? 'Pensamiento lógico y resolución de problemas',
