...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Use transaction to check and update deviceId atomically
      final userRef =
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        if (!userDoc.exists) {
          ...
          debugPrint('Stored deviceId for user ${user.uid}: $storedDeviceId');
          ...
          if (storedDeviceId == null) {
            transaction.update(userRef, {'deviceId': currentDeviceId});
            debugPrint(
                'Updated deviceId to $currentDeviceId for user ${user.uid}');
          }
        }
      });
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        floatingLabelStyle:
            const TextStyle(color: AppColors.progressBrightBlue),
      ),
      validator: validator,
    );
  }
