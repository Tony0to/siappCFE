...
import 'package:siapp/screens/module4screens/tema1.dart';
  ...
  Future<void> _loadModuleProgress() async {
    ...
    try {
      ...
      final progressDoc = await FirebaseFirestore.instance
          ...
          .doc(user.uid)
          .collection('modules')
          .doc(widget.moduleData['id'] ?? 'module4')
          .get();
  ...
  Future<void> _resetModuleProgress() async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'module_id': widget.moduleData['id'] ?? 'module4',
        'module_title': widget.moduleData['module_title'] ?? 'Paradigmas de Programación',
        'completed': false,
